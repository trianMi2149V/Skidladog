...
ImageButton.Image="http://www.roblox.com/asset/?id= 120625663245574"
...
Tabs.Info:AddButton({
        ...
        Description="Discord",
        Callback=function()
            setclipboard(tostring("https://discord.gg/GZSmF2bh8y")) 
        end
})
Tabs.Info:AddButton({
    Title="Yataki Roblox",
    Description="Youtube",
    Callback=function()
        setclipboard(tostring("https://www.youtube.com/@YatakiRoblox"))
    end
})
Tabs.Info:AddButton({
    Title="Fix lag máy yếu",
    Description="Fix lag xóa 100%",
    Callback=function()
...
Tabs.Info:AddParagraph({
    Title="Cập Nhật",
    Content="Tôi Sẽ Cập Nhiều Nhiều Tính Năng Hơn Để Mang Đến Cho Các Bạn Trải Nghiệm Tốt Nhất\Nếu Có Lỗi Hãy Kiên Nhẫn Chờ Tôi Fix Vì Tôi Không Thể Thử Nghiệm Hết"
})
Tabs.Info:AddParagraph({
